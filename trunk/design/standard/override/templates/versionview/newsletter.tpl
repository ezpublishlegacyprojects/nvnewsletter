...
<div class="box-bc"><div class="box-ml"><div class="box-mr"><div class="box-br"><div class="box-bl"><div class="box-content">
    ...
    <div class="block float-break">
        ...
        <input type="text" name="PreviewEmail" />
    </div>
...
<a href={concat("nvnewsletter/preview/",$object.id,"/",$version.version,"/",$language, '/html/1')|ezurl} target="_blank"><img src={"images/view-fullscreen.png"|ezdesign} /></a>
</p>
<div class="break"></div>
</div>
...
{if or( and( eq( $version.status, 0 ), $is_creator, $object.can_edit ),
    ...
    {* Disable Publish button because we can't controll redirect. *}
