...
{* nvNewsletter - Failed newsletter list *}

{def $newsletterCount=fetch('nvnewsletter', 'failed_newsletter_count')
     ...
     $groupData = ''
     $senderData = ''}
<form name="newsletters" method="post" action={'/nvnewsletter/list_failed/'|ezurl}>
<div class="context-block">
{* DESIGN: Header START *}<div class="box-header"><div class="box-tc"><div class="box-ml"><div class="box-mr"><div class="box-tl"><div class="box-tr">
<h1 class="context-title">{'Failed newsletters'|i18n( 'design/nvnewsletter' )}</h1>
...
<tr><td>&nbsp;</td><td colspan="6">{'No failed newsletters'|i18n( 'design/nvnewsletter' )}</td><td>&nbsp;</td></tr>
{else}
...
{include name=navigator
         ...
         page_uri='/nvnewsletter/list_failed'
...
<div class="block">
<input type="hidden" name="RedirectURIAfterRemove" value={"/nvnewsletter/list_failed"|ezurl} />
