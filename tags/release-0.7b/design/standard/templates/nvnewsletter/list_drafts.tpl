...
{* nvNewsletter - Drafts newsletter list *}

{def $newsletterCount=fetch('nvnewsletter', 'drafts_newsletter_count')
...
<h1 class="context-title">{'Newsletter drafts'|i18n( 'design/nvnewsletter' )}</h1>
...
<tr><td>&nbsp;</td><td colspan="5">{'No newsletter drafts'|i18n( 'design/nvnewsletter' )}</td><td>&nbsp;</td></tr>
{else}
...
{include name=navigator
         ...
         page_uri='/nvnewsletter/list_drafts'
...
<div class="block">
<input type="hidden" name="RedirectURIAfterRemove" value={"/nvnewsletter/list_draft"|ezurl} />
