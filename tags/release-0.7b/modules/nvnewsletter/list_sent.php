...
if ($http->hasPostVariable('RemoveNewsletterButton')) 
{
    ...
    $Result['path'] = array( array( 'url' => false,
                                    'text' => ezi18n( 'design/nvnewsletter', 'Sent newsletters' ) ) );
    return;
} 
...
$newsletterArray = nvNewsletter::fetchByOffset( array( 'status' => nvNewsletter::STATUS_SENT ), 
                                                array( 'offset' => $offset, 
                                                       'length' => $limit ) );
...
$Result['left_menu']       = 'design:parts/content/nvnewsletter_menu.tpl';
$Result['content']         = $tpl->fetch("design:$extension/list_sent.tpl");
$Result['path'] = array( array( 'url' => false,
                                'text' => ezi18n( 'design/nvnewsletter', 'Sent newsletters' ) ) );
?>